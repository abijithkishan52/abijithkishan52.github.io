...
const resumeFrame = document.querySelector('.resume-frame iframe');
if (resumeFrame) {
    resumeFrame.addEventListener('error', () => {
        const container = resumeFrame.parentElement;
        container.innerHTML = `
            <div style="padding: 2rem; text-align: center; background: #f0f0f0; border-radius: 10px;">
                ...
                <a href="resume.pdf" download class="btn btn-primary" style="display: inline-block; margin-top: 1rem;">
                    Download Resume
                </a>
            </div>
        `;
